...
**ad_keywords** = Amazon広告の推奨キーワード上位30・売れている検索語順。無い場合もある)。
...
**タイトルの検索キーワード選定**: `ad_keywords` (Amazon広告の推奨KW・売れている順) があれば
**候補プールとして優先的に参考にする** — 実際に検索・購入されている言葉の裏付けがある。
ただし Amazon と楽天は検索の癖が違うため**楽天向けに取捨選択**する (機械的に全部は入れない。
商品と無関係な語・競合ブランド名は使わない)。
