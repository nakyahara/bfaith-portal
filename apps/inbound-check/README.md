...
- 📷 カメラ = **zxing-wasm で自前でデコードする**。読んだ値を検索欄に入れて検索するだけ
  ...
  - テスト = `node scripts/test-inbound-check-barcode-scan.mjs` (61項目)。実機を持たずに「読める」と
    言わないための下限:
