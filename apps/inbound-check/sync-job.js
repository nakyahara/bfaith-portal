 ...
 *   INBOUND_CHECK_SYNC_CRON      … cron 式を上書き (既定 '*\/30 0-20 * * *' JST)
...
// JST 0〜20時台の毎時0分・30分。**深夜の枠は 2026-09-07 に追加**した —
// miniPC が 00:20 に取り直すようになったので、00:30 に取り込めば朝いちばんから当日ぶんの一覧になる
// (6時始まりのままだと、せっかく深夜に取っても反映は 6:00 まで待つことになる)。
// 21〜23時台は現場が動いていないので入れない
const DEFAULT_CRON = '*/30 0-20 * * *';
