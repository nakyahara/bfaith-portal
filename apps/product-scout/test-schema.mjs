...
assert.deepStrictEqual(tables,
  ['scout_categories', 'scout_concepts', 'scout_decisions', 'scout_keyword_cards', 'scout_keyword_decisions', 'scout_keyword_runs', 'scout_own_families', 'scout_own_imports', 'scout_snapshots']);
ok('9テーブルが作られる');
