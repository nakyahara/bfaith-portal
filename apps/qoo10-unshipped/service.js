 ...
 *   弊社は12時締め。前日12:00までに発送できる状態だった注文は当日中に出荷されているはず。
 ...
 *
 * ⚠️入金確認の時刻を持つフィールドが無い (payment_date は API が返しておらず全件空)。
 *   注文日時で判定する。前払い (コンビニ決済) は入金前は 'Awaiting shipping(1)' なので
 *   そもそも対象外になり、入金されて初めて 'Seller confirm(3)' に上がる。
 *
 * 個人情報:
