...
export const JOBS_REGISTRY = [
  ...
  // ─────────────── scheduled_job (miniPC Task Scheduler) ───────────────
  {
    ...
    purpose: '全出品の想定利益 (単品販売シナリオ) を夜間計算。'
      ...
      + '+ au PAY searchItemInfos/searchStocks + Qoo10 GetAllGoodsInfo/GetItemDetailInfo) → モール登録価格の取得 → '
    ...
    runbook: '🚨 成功 ping は「Render の公開ポインタが対象世代になった」ことを読み戻して確認してから打つ。'
      ...
      + 'AUPAY_PROXY_URL / AUPAY_PROXY_SECRET / AUPAY_SHOP_ID / QOO10_CERT_KEY / RENDER_MIRROR_URL / MIRROR_SYNC_KEY / JOBS_MONITOR_TOKEN。'
