...
node apps/company-db/push/mall-orders.mjs --relink                                    # 伝票との結び直しを 1 回 (初回 9/16 実測: 50.9 万伝票を 2,000 件 × 256 回 = 86 秒で完走・結んだ 265,909 件)
